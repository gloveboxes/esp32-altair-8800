...
#ifndef _ESP32_88DCDD_SD_CARD_H_
#define _ESP32_88DCDD_SD_CARD_H_
...
typedef struct
{
    FILE* file;                              // Standard C file handle
...
typedef struct
{
    esp32_sd_disk_t disk[MAX_DRIVES];
    esp32_sd_disk_t* current;
    uint8_t currentDisk;
} esp32_sd_disk_controller_t;

// Global disk controller
extern esp32_sd_disk_controller_t esp32_sd_disk_controller;
...
#endif // _ESP32_88DCDD_SD_CARD_H_
